class ProductData {
  ...
  static const List<Map<String, dynamic>> newArrivals = [
    {
      ...
      "discount": "15% Off",
      "gallery": [
        "assets/images/adidas_samba2.png",
        "assets/images/adidas_samba1.png",
        "assets/images/adidas_samba.png",
      ],
    },

    {
      ...
      "gallery": [
        "assets/images/Women Black Pure Cotton Solid Mid Length Regular Fit Formal Shirt Dress.webp",
        "assets/images/Women Black Pure Cotton Solid Mid Length Regular Fit Formal Shirt Dress1.png",
        "assets/images/Women Black Pure Cotton Solid Mid Length Regular Fit Formal Shirt Dress2.png",
      ],
    },

    {
      ...
      "discount": "15% Off",
      "gallery": [
        "assets/images/The Pixel 9 with Gemini and AI.png",
        "assets/images/The Pixel 9 with Gemini and AI 1.png",
        "assets/images/The Pixel 9 with Gemini and AI 2.png",
      ],
    },

    {
      ...
      "discount": "10% Off",
      "gallery": [
        "assets/images/Nike Air Force 1 2.png",
        "assets/images/Nike Air Force 1 1.png",
  ...
  static const List<Map<String, dynamic>> mostWanted = [
    {
      ...
      "discount": "10% Off",
      "gallery": [
        "assets/images/Classic White Sneakers.webp",
        "assets/images/Classic White Sneakers1.png",
        "assets/images/Classic White Sneakers2.png",
      ],
    },
  ...
  static const List<String> fashionImages = [
